...
namespace ChatBot_POE_2
{
    ...
    public class respond
    {
        ...
        {//start of method
            ...
            add_answers.Add("greeting i'm feeling good today, thanks! how has your day been so far?");
            add_answers.Add("greeting i'm doing great, thank you! what can i assist you with today?");
            add_answers.Add("greeting everything is going well on my side! hope you're having a good day too?");
            add_answers.Add("greeting hello! how are you doing today?");
            add_answers.Add("greeting hey there! i'm doing awesome today, thanks for asking!");
            add_answers.Add("greeting hi! i'm having a wonderful day so far, what about you?");//Greeting messages
            ...
            add_answers.Add("purpose my goal is to help you stay safe in the digital world by explaining cybersecurity concepts.");
            add_answers.Add("purpose i am here to support you with learning how to protect your data and online identity.");//Purpose messages
            ...
            add_answers.Add("cybersecurity it is the practice of defending computers, servers, and networks from malicious activity.");
            add_answers.Add("cybersecurity it helps ensure data, devices, and users are safe from cyber attacks.");//Cybersecurity messages
            ...
            add_answers.Add("phishing it often arrives through emails or messages that look real but are designed to steal information.");
            add_answers.Add("phishing is a form of cyber attack that tricks users into clicking malicious links or sharing passwords.");//Phishing question messages
            ...
            add_answers.Add("firewall it monitors incoming and outgoing traffic to prevent unauthorized access.");
            add_answers.Add("firewall is a security system that filters data entering or leaving a network.");// Firewall question messages
            ...
            add_answers.Add("password it is a secret combination used to verify your identity online.");
            add_answers.Add("password strong passwords help protect your accounts from hackers.");//Password question messages
            ...
            add_answers.Add("hacked account change your password immediately and check for suspicious activity.");
            add_answers.Add("hacked account review your security settings and recover access as soon as possible.");//Hacked account question messages
            ...
            add_answers.Add("fraud is illegal deception used to gain money or personal information.");
            add_answers.Add("fraud should always be reported quickly to reduce damage and prevent losses.");//Fraud question messages
            ...
            add_answers.Add("malicious chatbot they are designed to trick users into revealing private information.");
            add_answers.Add("malicious chatbot always verify who you are talking to before sharing details.");//Malicious chatbot question messages
            ...
            add_answers.Add("vpn hides your online activity by encrypting your connection.");
            add_answers.Add("vpn helps keep your data private when browsing the internet.");//VPN question messages
            ...
            add_answers.Add("frustrated i know this can be annoying, but we'll solve it together.");
            add_answers.Add("frustrated let's break the problem down so it becomes easier to fix.");
            add_answers.Add("frustrated take a breath, we'll fix this together.");//Frustration messages
            ...
            add_answers.Add("confused i'll simplify it so it's easier to follow.");
            add_answers.Add("confused let's go through it slowly so everything becomes clear.");
            add_answers.Add("confused no worries, i'll help you understand it better.");//Confusion messages
            ...
            add_answers.Add("worried you're not alone, we'll handle this step by step.");
            add_answers.Add("worried let's check everything carefully so you feel more secure.");
            add_answers.Add("worried i understand your concern. let's make sure your information is safe.");//Worry messages
            ...
            add_answers.Add("happy that's wonderful to hear, keep it up!");
            add_answers.Add("happy great to see you're feeling good today!");
            add_answers.Add("happy i'm happy for you! let me know if you need anything.");//Happy messages
            ...
            add_answers.Add("sad i'm here to support you if you need to talk.");
            add_answers.Add("sad it’s okay to feel this way, things can get better with time.");
            add_answers.Add("sad i hope things improve soon. you can talk to me anytime.");//Sad messages
            ...
            add_answers.Add("angry i hear your frustration, we'll work through it together.");
            add_answers.Add("angry take your time, i'm here to help you sort it out.");//Angry messages
